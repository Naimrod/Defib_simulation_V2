    ...
    <div className={styles.container}>
      ...
      <div style={{ display: "flex", gap: "25px", alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        <div className={styles.panelContainer} style={{ overflowY: "scroll", width: "30%", height: "85vh" }}>
          ...
          <AccordionSection title="🎬 Scénario" color="#ffffff" defaultOpen={true} summary={props.scenarioId}>
          ...
          <AccordionSection title="Cœur" color="#51ff00" defaultOpen={true} summary={`${props.rhythmLabel} · ${props.bpm} BPM · SpO2 ${props.spo2}% · ${props.systolic}/${props.diastolic} mmHg`}>
